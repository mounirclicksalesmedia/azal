...
const STORAGE_KEY = 'arsh:attribution';
...
export default function Booking({ dict, lang }: Props) {
  ...
  return (
    <section className="arsh-booking" id="booking">
      <div className="arsh-container arsh-book-grid">
        <Reveal>
        ...
        <Reveal>
          <form className="arsh-form-card" onSubmit={onSubmit} noValidate aria-live="polite">
            <div className="arsh-form-title">
              {submitted ? b.thanks : b.formTitle}
            </div>
            <div className="arsh-form-sub">{b.formSub}</div>

            <label className="arsh-field">
            ...
            <div className="arsh-submit-row">
              <p className="arsh-form-fine">
                {error ? error : b.fine}
              </p>
